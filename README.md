...
Los esquemas de usos por planta (L0…L9 + Roof) del final de Programme son los **exports
reales de Revit** (`assets/img/scheme-00.png` … `scheme-10.png`), con la etiqueta original
recortada y fondo transparente.
